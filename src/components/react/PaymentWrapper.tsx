  ...
  const steps: Netsystems.PaymentFormInfo[] = [
    {
      ...
      bannerImage: "/images/payment-form/aside-1.webp",
      form: <Login />,
    },
    {
      title: "Seleccione el metodo de pago",
      subtitle: "Puede elegir entre las siguientes opciones",
      bannerImage: "/images/payment-form/aside-2.webp",
      form: <PaymentMethod />,
    },
    {
      ...
      label: "paso 1",
      bannerImage: "/images/payment-form/aside-3.webp",
      form: <Contract />,
    ...
    },
    {
      ...
      label: "paso 2",
      bannerImage: "/images/payment-form/aside-4.webp",
      form: <UserData />,
    ...
    },
    {
      ...
      label: "paso 3",
      bannerImage: "/images/payment-form/aside-5.webp",
      form: <PaymentReport />,
    ...
    },
    {
      ...
      label: "paso 4",
      bannerImage: "/images/payment-form/aside-6.webp",
